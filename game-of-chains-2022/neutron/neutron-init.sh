#!/bin/bash
# Set up a neutron service to join the neutron chain.
...
NODE_HOME=~/.neutron
NODE_MONIKER=neutron
# ***

# CHAIN_BINARY_URL='https://github.com/hyphacoop/ics-testnets/raw/main/game-of-chains-2022/neutron/neutrond'
CHAIN_BINARY='neutrond'
CHAIN_ID=neutron
PERSISTENT_PEERS="4b5cee15e6a9c4b96b8c1c4f396a18b0461edc17@164.92.123.223:26656,835173badfc41ecbd867a0395c6a452bda2bb90f@164.92.123.238:26656"
...
echo "Description=neutron service"       | sudo tee /etc/systemd/system/$NODE_MONIKER.service -a
...
echo "***********************"
echo "After you have updated the genesis file, start the neutron service:"
