#!/bin/bash
# Set up an interchain-security-cd service to join the sputnik chain.
...
NODE_HOME=~/.sputnik
NODE_MONIKER=sputnik
# ***

CHAIN_BINARY_URL='https://github.com/hyphacoop/ics-testnets/raw/main/game-of-chains-2022/sputnik/interchain-security-cd'
CHAIN_BINARY='sputnikd'
CHAIN_ID=sputnik
PERSISTENT_PEERS="4b5cee15e6a9c4b96b8c1c4f396a18b0461edc17@46.101.106.107:26656,835173badfc41ecbd867a0395c6a452bda2bb90f@134.209.255.244:26656"
...
echo "Description=Sputnik service"       | sudo tee /etc/systemd/system/$NODE_MONIKER.service -a
...
echo "***********************"
echo "After you have updated the genesis file, start the Sputnik service:"
