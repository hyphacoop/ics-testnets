#!/bin/bash
# Set up a hero service to join the hero-1 chain.
...
CHAIN_BINARY_URL='https://github.com/hyphacoop/ics-testnets/raw/main/game-of-chains-2022/hero/herod'
CHAIN_BINARY='herod'
CHAIN_ID=hero-1
...
# rm -rf hero
# git clone https://github.com/strangelove-ventures/hero.git
# cd hero
...
echo "***********************"
echo "After you have updated the genesis file, start the hero service:"
