...
CHAIN_BINARY_URL='https://github.com/hyphacoop/ics-testnets/raw/main/game-of-chains-2022/slasher/interchain-security-cd'
CHAIN_BINARY='slasherd'
CHAIN_ID=slasher
PERSISTENT_PEERS="4b5cee15e6a9c4b96b8c1c4f396a18b0461edc17@slasher-coordinator.goc.earthball.xyz:26656,835173badfc41ecbd867a0395c6a452bda2bb90f@slasher-backup.goc.earthball.xyz:26656"
SEEDS="7a86ddc92f56e77a26c4fb4d543412f7175a7c9b@slasher-seed.goc.earthball.xyz:26656"
...
# git checkout 830218cebff472dba3c6ee62b1773ecc9defeae3
# make install
...
echo "ExecStart=$HOME/go/bin/cosmovisor start --x-crisis-skip-assert-invariants --home $NODE_HOME --p2p.persistent_peers $PERSISTENT_PEERS --p2p.seeds $SEEDS" | sudo tee /etc/systemd/system/cv-$NODE_MONIKER.service -a
...
# Add go and chain binary to the path
