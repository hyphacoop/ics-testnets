#!/bin/bash
# Set up an interchain-security-cd service to join the apollo chain.
...
echo "Description=apollo service"       | sudo tee /etc/systemd/system/$NODE_MONIKER.service -a
...
echo "***********************"
echo "After you have updated the genesis file, start the apollo service:"
